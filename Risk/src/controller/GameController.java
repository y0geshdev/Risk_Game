...
public class GameController {
	...
	/**
	 * Variable to hold user's choice for saving game at any consistent state and exit
	 */
	@FXML
	...
	/**
	 * Reference to map containing map and corresponding result of games played on the map
	 */
	...
	/**
	 * This method handle {@link #addReinforcement(ActionEvent)} button event. It adds
	...
	/**
	 * This method handles {@link #attack(ActionEvent) button. It
	...
	/**
	 * This method handles {@link #attackAttackerCB} comboBox value
	 * change event to update {@link #attackDefenderCB} comboBox
	 * values.
	 * 
	 * @param event:
	 *            ActionEvent instance which is generated by user.
	...
	/**
	 * This method handles {@link  #finishAttack(ActionEvent)} button event.
	...
	/**
	 * This method handles fortifyMoveButton button event. It
	...
	/**
	 * This method handles {@link #fortifyFromTerritoryCB} comboBox
	 * value change event to update {@link #fortifyToTerritoryCB}
	 * comboBox values.
	 * 
	 * @param event:
	 *            ActionEvent instance which is generated by user.
	...
	/**
	 * This method handle {@link #saveGame} button event and save the game
	...
	/**
	 * This method handle {@link #saveAndExitGame} button event and save the game
	...
	/**
	 * Setter for playerstrategyEnumMap sets player to corresponding strategy in a Map
	 * @param playerList:
