...
public class ModeController {
	...
	/**
	 * Variable for reference for ComboBox to hold players list in tournament mode
	 */
	@FXML
	private ComboBox<Player> playerListTM;

	/**
	 * Variable for reference for listview to hold all Strategies in tournament mode
	 */
	@FXML
	private ListView<PlayerStrategyEnum> allStrategiesTM;

	/**
	 * Variable for reference for listview to hold player's Strategies in tournament
	 * mode
	 */
	@FXML
	...
	/**
	 * Variable for reference for TextField to get moves for draw in tournament
	 * mode.
	 */
	@FXML
	...
	/**
	 * Variable for reference for TextField to get total number of games in
	 * tournament mode.
	 */
	@FXML
	...
	/**
	 * Variable for reference for TextField to get path of map1 file in tournament
	 * mode.
	 */
	@FXML
	...
	/**
	 * Variable for reference for TextField to get path of map2 file in tournament
	 * mode.
	 */
	@FXML
	...
	/**
	 * Variable for reference for TextField to get path of map3 file in tournament
	 * mode.
	 */
	@FXML
	...
	/**
	 * Variable for reference for TextField to get path of map4 file in tournament
	 * mode.
	 */
	@FXML
	...
	/**
	 * Variable for reference for TextField to get path of map5 file in tournament
	 * mode.
	 */
	@FXML
	...
	/**
	 * Variable for reference for TextField to get number of players in tournament
	 * mode.
	 */
	@FXML
	...
	/**
	 * Variable for reference for TextField to get path of map1 file in single mode.
	 */
	@FXML
	private TextField map1PathSM;

	/**
	 * Variable for reference for TextField to get number of players in single mode.
	 */
	@FXML
	private TextField noOfPlayerSM;

	/**
	 * Variable for reference for ComboBox to hold players list in single mode
	 */
	@FXML
	private ComboBox<Player> playerListSM;

	/**
	 * Variable for reference for listview to hold all Strategies in single mode
	 */
	@FXML
	private ListView<PlayerStrategyEnum> allStrategiesSM;

	/**
	 * Variable for reference for listview to hold player's Strategies in single
	 * mode
	 */
	@FXML
	...
	/**
	 * This method handles setting of player strategy and validates accordingly for
	 * tournament mode
	 * 
	 * @param event
	...
	/**
	 * This method handles the add player strategy for tournament mode action event
	 * 
	 * @param event
	 *            : ActionEvent instance which is generated by user.
	 */
	...
	/**
	 * This method handles the remove player strategy for tournament mode action
	 * event
	 * 
	 * @param event
	 *            : ActionEvent instance which is generated by user.
	...
	/**
	 * This method handles the add player strategy for single mode action event
	 * 
	 * @param event
	 *            : ActionEvent instance which is generated by user.
	 */
	...
	/**
	 * This method handles the remove player strategy for single mode action event
	 * 
	 * @param event
	 *            : ActionEvent instance which is generated by user.
	 */
	...
	/**
	 * This method handles action of choosing map file by user in single mode
	 * 
	 * @param event:
	 *            ActionEvent instance which is generated by user.
	 */
	...
	/**
	 * This method handles action of choosing map files by user in tournament mode
	 * 
	 * @param event:
	 *            ActionEvent instance which is generated by user.
	 */
	...
	/**
	 * This method handles action of updating player mapped strategies single mode
	 * 
	 * @param event:
	 *            ActionEvent instance which is generated by user.
	 */
	...
	/**
	 * This method handles action of updating player mapped strategies tournament
	 * mode
	 * 
	 * @param event:
	 *            ActionEvent instance which is generated by user.
