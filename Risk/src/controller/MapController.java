...
public class MapController {
	...
	/**
	 * This method handle {@link #generateMapButton} button event. This
	...
	/**
	 * This method handle {@link #chooseMapsButton} button event and open a
	...
	/**
	 * This method handle {@MapController#chooseGame} button event and open a
	...
	/**
	 * This method handle {@MapController#contsCB} ComboBox value change event
	...
	/**
	 * This method handle {@link #addTerrsToContsButton} button event
	...
	/**
	 * This method handle {@link #removeTerrsToContsButton} button
	...
	/**
	 * This method handle {@link #terrsCB} ComboBox value change event
	 * to update related territories on UI.
	 * 
	 * @param event:
	 *            ActionEvent instance which is generated by user.
	...
	/**
	 * This method handle {@link #addTerrsToTerrsButton} button event
	...
	/**
	 * This method handle {@link #removeTerrsToTerrsButton} button
	...
	/**
	 * This method handle {@link #updateContiControlValueButton} button
	 * event to update selected continent army value in Continent object in
	 * {@link #continentTerritoriesMapping} mapping.
	 * 
	 * @param event:
	 *            ActionEvent instance which is generated by user.
	 */
	...
	/**
	 * This method handle {@link #saveMapButton} button event. It
	...
	/**
	 * This method handles {@link #modifyMapButton} event. It loads the
	...
	/**
	 * This method handles {@link #startGameButton} event. It loads the
	...
	public void startGame(ActionEvent event) {
		 ...
		 /*modeController.disableSMComponents();
		 modeController.disableTMComponents();*/
		 stage.show();
	...
	private void showError(String error) {
	 ...
	 /** This method handle {@link #chooseGame} button event and open a
		 * dialog box to choose a map file to play game.
		 * 
		 * @param event:
		 *            ActionEvent instance which is generated by user.
		...
		/**
		 * This method handle {@link #resumeGame} button event and starts the game from
		 * state saved in chosen file and validate accordingly
		 * @param event:
		 * 			 ActionEvent instance which is generated by user.
		 */
